!(function(t, e) {
  "object" == typeof exports && "object" == typeof module
    ...
    ? (exports["echarts-wordcloud"] = e(require("echarts")))
    : (t["echarts-wordcloud"] = e(t.echarts));
})(this, function(t) {
  return (function(t) {
    function e(n) {
      ...
      (n.prototype = {
        ...
        brush: function(t, e) {
          ...
          if ((r.bind(t, this, e), this.setTransform(t), this.__dirty)) {
            var v;
            l &&
              ((v = v || this.getBoundingRect()),
              (this._fillGradient = r.getGradient(t, o, v))),
              u &&
                ((v = v || this.getBoundingRect()),
                (this._strokeGradient = r.getGradient(t, s, v)));
          }
          l
            ? (t.fillStyle = this._fillGradient)
            : f && (t.fillStyle = h.call(o, t)),
            u
              ? (t.strokeStyle = this._strokeGradient)
              : d && (t.strokeStyle = h.call(s, t));
          var g = r.lineDash,
            p = r.lineDashOffset,
            m = !!t.setLineDash,
            x = this.getGlobalScale();
          n.setScale(x[0], x[1]),
            this.__dirtyPath || (g && !m && i)
              ? (n.beginPath(t),
                g && !m && (n.setLineDash(g), n.setLineDashOffset(p)),
                this.buildPath(n, this.shape, !1),
                this.path && (this.__dirtyPath = !1))
              : (t.beginPath(), this.path.rebuildPath(t)),
            a && n.fill(t),
            g && m && (t.setLineDash(g), (t.lineDashOffset = p)),
            i && n.stroke(t),
            g && m && t.setLineDash([]),
        ...
        getBoundingRect: function() {
          ...
          if (((this._rect = t), e.hasStroke())) {
            ...
            if (this.__dirty || r) {
              ...
              e.hasFill() ||
                (a = Math.max(a, this.strokeContainThreshold || 4)),
                s > 1e-10 &&
                  ((i.width += a / s),
                  (i.height += a / s),
                  (i.x -= a / s / 2),
        ...
        contain: function(t, e) {
          ...
          if (((t = r[0]), (e = r[1]), n.contain(t, e))) {
            ...
            if (i.hasStroke()) {
              ...
              if (
                l > 1e-10 &&
                (i.hasFill() || (o = Math.max(o, this.strokeContainThreshold)),
                s.containStroke(a, o / l, t, e))
              )
                return !0;
            }
    ...
    function(t, e) {
      function r(t, e) {
        var r = new S(2);
        return (
          null == t && (t = 0), null == e && (e = 0), (r[0] = t), (r[1] = e), r
        );
      }
      function n(t, e) {
      ...
      (n.prototype = {
        ...
        calculateTransform: function(t) {
          var e = this,
            ...
            i = a.create();
          return (
            a.translate(i, i, [-e.x, -e.y]),
            a.scale(i, i, [r, n]),
            a.translate(i, i, [t.x, t.y]),
            i
          );
        },
        ...
        contain: function(t, e) {
          var r = this;
          return (
            t >= r.x && t <= r.x + r.width && e >= r.y && e <= r.y + r.height
          );
        },
        clone: function() {
    ...
    function(t, e, r) {
          ...
          (d = f - m),
            ...
            d >= 0 && g < x
              ...
              : ((P[0] = a(t, r, i, s, v)),
                (P[1] = a(e, n, o, l, v)),
                (p = y(P, k)),
                v <= 1 && p < x ? ((f = v), (x = p)) : (m *= 0.5));
        return (
          c && ((c[0] = a(t, r, i, s, f)), (c[1] = a(e, n, o, l, f))), _(x)
        );
      }
      function c(t, e, r, n) {
        var i = 1 - n;
      ...
      (e.cubicAt = a),
        ...
        (e.quadraticAt = c),
        (e.quadraticDerivativeAt = f),
        (e.quadraticRootAt = d),
        (e.quadraticExtremum = v),
        (e.quadraticSubdivide = g),
    ...
    function(t, e, r) {
      ...
      function d(t, e) {
        ...
        for (var s = 0; ; s++) {
          ...
          var l =
            0 === s
              ? v(t, a, e.ascCharWidth, e.cnCharWidth)
              : o > 0
              ? Math.floor((t.length * a) / o)
              : 0;
      ...
      function m(t, e, r, n) {
        ...
        if ((r && (s += r[0] + r[2]), t && n)) {
          ...
          if (null != l && s > l) (t = ""), (a = []);
            ...
            for (
              var u = f(h - (r ? r[1] + r[3] : 0), e, n.ellipsis, {
                  minChar: n.minChar,
      ...
      function x(t, e) {
            ...
            if ("string" == typeof D && "%" === D.charAt(D.length - 1))
              ...
              if (L) {
                ...
                var F = T.textBackgroundColor,
                  R = F && F.image;
                R &&
                  ((R = b.findExistImage(R)),
                  b.isImageReady(R) &&
                    (D = Math.max(D, (R.width * A) / R.height)));
              }
              var B = P ? P[1] + P[3] : 0;
              D += B;
              ...
              null != z &&
                z < D &&
                (!L || z < B
                  ? ((M.text = ""), (M.textWidth = D = 0))
                  : ((M.text = c(M.text, z - B, I, d.ellipsis, {
                      minChar: d.minChar
                    })),
                    (M.textWidth = i(M.text, I)),
                    (D = M.textWidth + B)));
        ...
        (r.outerWidth = r.width = k(e.textWidth, h)),
          (r.outerHeight = r.height = k(e.textHeight, l)),
          f && ((r.outerWidth += f[1] + f[3]), (r.outerHeight += f[0] + f[2]));
    ...
    function(t, e, r) {
      ...
      (_.prototype = {
        ...
        lineTo: function(t, e) {
          var r =
            y(t - this._xi) > this._ux ||
            y(e - this._yi) > this._uy ||
            this._len < 5;
          return (
        ...
        arc: function(t, e, r, n, i, a) {
          return (
            this.addData(h.A, t, e, r, r, n, i - n, 0, a ? 0 : 1),
        ...
        closePath: function() {
          ...
          var t = this._ctx,
            ...
            r = this._y0;
          return (
            t && (this._needsDash() && this._dashedLineTo(e, r), t.closePath()),
            (this._xi = e),
            (this._yi = r),
            this
          );
        ...
        _dashedBezierTo: function(t, e, r, i, a, o) {
          ...
          for (d < 0 && (d = f + d), d %= f, s = 0; s < 1; s += 0.1)
            (l = y(p, t, r, a, s + 0.1) - y(p, t, r, a, s)),
              (h = y(m, e, i, o, s + 0.1) - y(m, e, i, o, s)),
              (w += x(l * l + h * h));
          for (; _ < b && !((S += v[_]) > d); _++);
          for (s = (S - d) / w; s <= 1; )
            (u = y(p, t, r, a, s)),
              (c = y(m, e, i, o, s)),
              _ % 2 ? g.moveTo(u, c) : g.lineTo(u, c),
              (s += v[_] / w),
              (_ = (_ + 1) % b);
          _ % 2 != 0 && g.lineTo(a, o),
            (l = a - u),
            (h = o - c),
            (this._dashOffset = -x(l * l + h * h));
        },
        ...
        toStatic: function() {
          var t = this.data;
          t instanceof Array &&
            ((t.length = this._len), w && (this.data = new Float32Array(t)));
        },
        getBoundingRect: function() {
          (u[0] = u[1] = f[0] = f[1] = Number.MAX_VALUE),
            (c[0] = c[1] = d[0] = d[1] = -Number.MAX_VALUE);
          for (
            var t = this.data, e = 0, r = 0, n = 0, s = 0, l = 0;
            l < t.length;

          ) {
            var v = t[l++];
            switch (
              (1 == l && ((e = t[l]), (r = t[l + 1]), (n = e), (s = r)), v)
            ) {
              case h.M:
                (n = t[l++]),
                  (s = t[l++]),
              ...
              case h.C:
                ...
                break;
              case h.Q:
                a.fromQuadratic(e, r, t[l++], t[l++], t[l], t[l + 1], f, d),
                  (e = t[l++]),
                  (r = t[l++]);
                break;
              case h.A:
                var g = t[l++],
                  ...
                  b = t[l++] + _,
                  S = (t[l++], 1 - t[l++]);
                1 == l && ((n = p(_) * y + g), (s = m(_) * w + x)),
                  a.fromArc(g, x, y, w, _, b, S, f, d),
                  (e = p(b) * y + g),
                  (r = m(b) * w + x);
                break;
              case h.R:
          ...
          return (
            0 === l && (u[0] = u[1] = c[0] = c[1] = 0),
            new o(u[0], u[1], c[0] - u[0], c[1] - u[1])
          );
        },
    ...
    function(t, e, r) {
      ...
      function c(t, e, r) {
        ...
        for (
          var i = Math.pow(10, r),
            a = w.map(t, function(t) {
              return ((isNaN(t) ? 0 : t) / n) * i * 100;
            }),
            o = 100 * i,
            s = w.map(a, function(t) {
              return Math.floor(t);
            }),
            l = w.reduce(
              s,
          ...
          for (
            var u = Number.NEGATIVE_INFINITY, c = null, f = 0, d = h.length;
            f < d;
            ++f
          )
            h[f] > u && ((u = h[f]), (c = f));
      ...
      function v(t) {
        ...
        if ("string" == typeof t) {
          ...
          if (e[8]) {
            var r = +e[4] || 0;
            return (
              "Z" !== e[8].toUpperCase() && (r -= e[8].slice(0, 3)),
              new Date(
                Date.UTC(
                  +e[1],
                  +(e[2] || 1) - 1,
      ...
      function x(t) {
        function e(t, r, n) {
          return (
            t.interval[n] < r.interval[n] ||
            (t.interval[n] === r.interval[n] &&
              (t.close[n] - r.close[n] == (n ? -1 : 1) || (!n && e(t, r, 1))))
          );
        }
        t.sort(function(t, r) {
          return e(t, r, 0) ? -1 : 1;
      ...
      (e.linearMap = i),
        ...
        (e.getPercentWithPrecision = c),
        (e.MAX_SAFE_INTEGER = 9007199254740991),
        (e.remRadian = f),
        (e.isRadianAroundZero = d),
        (e.parseDate = v),
        (e.quantity = g),
        (e.nice = m),
        (e.reformIntervals = x),
      ...
      function i(t, e, r, n, i) {
        if (t) {
          if ("string" == typeof t) {
            ...
            var s = l.get(t),
              h = { hostEl: r, cb: n, cbPayload: i };
            return (
              s
                ? ((e = s.image), !o(e) && s.pending.push(h))
                : (!e && (e = new Image()),
                  (e.onload = a),
                  l.put(t, (e.__cachedImgObj = { image: e, pending: [h] })),
              ...
              return (
                ...
                o && (r.weChat = !0),
                {
                  ...
                  touchEventsSupported:
                    "ontouchstart" in window && !r.ie && !r.edge,
                  pointerEventsSupported:
                    "onpointerdown" in window &&
                    (r.edge || (r.ie && r.version >= 11))
                }
              );
            })(navigator.userAgent);
      var n = r;
          ...
          if ("#" !== n.charAt(0)) {
            ...
            if (-1 !== i && a + 1 === n.length) {
              ...
              switch (l) {
                ...
                case "rgb":
                  return 3 !== h.length
                    ? void u(e, 0, 0, 0, 1)
                    : (u(e, o(h[0]), o(h[1]), o(h[2]), d), f(t, e), e);
                case "hsla":
                  return 4 !== h.length
                    ? void u(e, 0, 0, 0, 1)
                    : ((h[3] = s(h[3])), v(h, e), f(t, e), e);
                case "hsl":
                  return 3 !== h.length
                    ? void u(e, 0, 0, 0, 1)
                    : (v(h, e), f(t, e), e);
            ...
            if (7 === n.length) {
              ...
              return g >= 0 && g <= 16777215
                ? (u(e, (16711680 & g) >> 16, (65280 & g) >> 8, 255 & g, 1),
                  f(t, e),
                  e)
                : void u(e, 0, 0, 0, 1);
            }
    ...
    function(t, e, r) {
      ...
      function i(t) {
        if (t) {
          ...
          var e = t.textAlign;
          "middle" === e && (e = "center"),
            (t.textAlign = null == e || O[e] ? e : "left");
          var r = t.textVerticalAlign || t.textBaseline;
          "center" === r && (r = "middle"),
            (t.textVerticalAlign = null == r || D[r] ? r : "top");
      ...
      function o(t, e, r, n, i) {
        ...
        (s && !t.__dirty) ||
          (s = t.__textCotentBlock = P.parsePlainText(r, a, o, n.truncate));
        var l = s.outerHeight,
          u = s.lines,
          d = s.lineHeight,
          x = v(l, n, i),
        ...
        g(e, "textAlign", b || "left"),
          g(e, "textBaseline", "middle"),
          g(e, "shadowBlur", n.textShadowBlur || 0),
          g(e, "shadowColor", n.textShadowColor || "transparent"),
          g(e, "shadowOffsetX", n.textShadowOffsetX || 0),
          g(e, "shadowOffsetY", n.textShadowOffsetY || 0),
          (k += d / 2);
        var D = n.textStrokeWidth,
          L = p(n.textStroke, D),
          F = m(n.textFill);
        L && (g(e, "lineWidth", D), g(e, "strokeStyle", L)),
          F && g(e, "fillStyle", F);
      ...
      function s(t, e, r, n, i) {
        ...
        (a && !t.__dirty) || (a = t.__textCotentBlock = P.parseRichText(r, n)),
          l(t, e, a, n, i);
      }
      ...
      function u(t, e, r, n, i, a, o, s) {
        ...
        var d = r.textPadding;
        d && ((o = y(o, s, d)), (u -= r.height / 2 - d[2] - r.textHeight / 2)),
          g(e, "shadowBlur", S(l.textShadowBlur, n.textShadowBlur, 0)),
          g(
            e,
            "shadowColor",
            l.textShadowColor || n.textShadowColor || "transparent"
          ),
          g(e, "shadowOffsetX", S(l.textShadowOffsetX, n.textShadowOffsetX, 0)),
          g(e, "shadowOffsetY", S(l.textShadowOffsetY, n.textShadowOffsetY, 0)),
          g(e, "textAlign", s),
          g(e, "textBaseline", "middle"),
          g(e, "font", r.font || P.DEFAULT_FONT);
        ...
        v &&
          (g(e, "lineWidth", w),
          g(e, "strokeStyle", v),
          e.strokeText(r.text, o, u)),
          x && (g(e, "fillStyle", x), e.fillText(r.text, o, u));
      }
      function c(t) {
        return (
          t.textBackgroundColor || (t.textBorderWidth && t.textBorderColor)
        );
      }
      function f(t, e, r, n, i, a, o) {
        var s = r.textBackgroundColor,
          ...
          u = k(s);
        if (
          (g(e, "shadowBlur", r.textBoxShadowBlur || 0),
          g(e, "shadowColor", r.textBoxShadowColor || "transparent"),
          g(e, "shadowOffsetX", r.textBoxShadowOffsetX || 0),
          g(e, "shadowOffsetY", r.textBoxShadowOffsetY || 0),
          u || (l && h))
        ) {
          e.beginPath();
          var c = r.textBorderRadius;
          c
            ? I.buildPath(e, { x: n, y: i, width: a, height: o, r: c })
            : e.rect(n, i, a, o),
            e.closePath();
        }
        if (u) g(e, "fillStyle", s), e.fill();
        else if (C(s)) {
          var f = s.image;
          (f = A.createOrUpdateImage(f, null, t, d, s)),
            f && A.isImageReady(f) && e.drawImage(f, n, i, a, o);
        }
      ...
      function v(t, e, r) {
        ...
        if (r) {
          ...
          if (s instanceof Array)
            (n = r.x + x(s[0], r.width)), (i = r.y + x(s[1], r.height));
          else {
      ...
      i.registerLayout(function(t, e) {
        t.eachSeriesByType("wordCloud", function(r) {
          function s(t) {
            var e = t.detail.item;
            t.detail.drawn &&
              r.layoutInstance.ondraw &&
              ((t.detail.drawn.gx += l.x / m),
              (t.detail.drawn.gy += l.y / m),
              r.layoutInstance.ondraw(e[0], e[1], e[2], t.detail.drawn));
          }
          ...
          o(u, {
            list: h
              .mapArray("value", function(t, e) {
                ...
                return [
                  h.getName(e),
                  r.get("textStyle.normal.textSize", !0) ||
                    i.number.linearMap(t, g, d),
                  e
                ];
              })
              .sort(function(t, e) {
            ...
            fontFamily:
              r.get("textStyle.normal.fontFamily") ||
              r.get("textStyle.emphasis.fontFamily") ||
              t.get("textStyle.fontFamily"),
            fontWeight:
              r.get("textStyle.normal.fontWeight") ||
              r.get("textStyle.emphasis.fontWeight") ||
          ...
          function e(t) {
            t &&
              i.util.each(n, function(e) {
                t.hasOwnProperty(e) &&
                  (t["text" + i.format.capitalFirst(e)] = t[e]);
              });
          }
          var r = (t || {}).series;
      ...
      function n(t, e, r, n, i) {
        ...
        e.eachChild(function(l, h) {
          ...
          if ("horizontal" === t) {
            ...
            (u = a + p),
              u > n || l.newline
                ? ((a = 0), (u = p), (o += s + r), (s = d.height))
                : (s = Math.max(s, d.height));
          } else {
            var m = d.height + (g ? -g.y + d.y : 0);
            (c = o + m),
              c > i || l.newline
                ? ((a += s + r), (o = 0), (c = m), (s = d.width))
                : (s = Math.max(s, d.width));
          }
          l.newline ||
            ((f[0] = a),
            (f[1] = o),
            "horizontal" === t ? (a = u + r) : (o = c + r));
        });
      }
      function i(t, e, r) {
        var n = e.width,
        ...
        return (
          ...
          (isNaN(l) || isNaN(parseFloat(t.y2))) && (l = i),
      ...
      function o(t, e, r, n, i) {
        ...
        if (o || s) {
          ...
          if ("raw" === l)
            h =
              "group" === t.type
                ? new f(0, 0, +e.width || 0, +e.height || 0)
                : t.getBoundingRect();
      ...
      function l(t, e, r) {
        function n(r, n) {
          ...
          if (
            ...
            return (
              a(e, r[1]) ? (h[r[2]] = null) : a(e, r[2]) && (h[r[1]] = null), h
            );
          if (2 !== u && l) {
            if (l >= 2) return o;
    ...
    function(t, e, r) {
      function n(t, e, r) {
        function n(t, e, r) {
          c[e]
            ? (t.otherDims[e] = r)
            : ((t.coordDim = e), (t.coordDimIndex = r), p.set(e, !0));
        }
        function o(t, e, r) {
          if (r || null != e.get(t)) {
        ...
        for (var w = 0; w < x; w++) {
          var _ = h(d[w]) ? { name: d[w] } : d[w] || {},
            b = _.name,
            S = (m[w] = { otherDims: {} });
          null != b &&
            null == g.get(b) &&
            ((S.name = S.tooltipName = b), g.set(b, w)),
        ...
        for (var T = r.extraPrefix || "value", k = 0; k < x; k++) {
          var S = (m[k] = m[k] || {});
          null == S.coordDim &&
            ((S.coordDim = o(T, p, r.extraFromZero)),
            (S.coordDimIndex = 0),
            (S.isExtraCoord = !0)),
      ...
      var a = r(0),
        ...
        h = a.isString,
        u = a.defaults,
        c = { tooltip: 1, label: 1, itemName: 1 },
    ...
    function(t, e, r) {
      ...
      function u(t) {
        ...
        S(t, function(t, r) {
          ...
          S(t, function(t, r) {
            ...
            if (M(i)) {
              if (
                ((a.name = null != i.name ? i.name + "" : n ? n.name : "\0-"),
                n)
              )
                a.id = n.id;
      ...
      function d(t, e) {
        return null != e.dataIndexInside
          ...
          ? y.isArray(e.dataIndex)
            ? y.map(e.dataIndex, function(e) {
                return t.indexOfRawIndex(e);
              })
            : t.indexOfRawIndex(e.dataIndex)
          : null != e.name
          ? y.isArray(e.name)
            ? y.map(e.name, function(e) {
          ...
          S(e, function(n, i) {
            ...
            if (
              !(
                ...
                (r &&
                  r.includeMainTypes &&
                  y.indexOf(r.includeMainTypes, s) < 0)
              )
            ) {
              var h = { mainType: s };
              ("index" === l && "all" === n) || (h[l] = n);
      ...
      (e.normalizeToArray = n),
        (e.defaultEmphasis = i),
        (e.TEXT_STYLE_OPTIONS = T),
        (e.getDataItemValue = a),
        ...
        (e.makeGetter = C),
        (e.parseFinder = v),
        (e.dataDimToCoordDim = g),
        (e.coordDimToDataDim = p),
        (e.otherDimToDataDim = m);
    },
    function(t, e, r) {
      function n(t, e, r) {
      ...
      (n.prototype = {
        ...
        get: function(t, e) {
          return null == t
            ? this.option
            : i(this.option, this.parsePath(t), !e && a(this, t));
        },
        ...
        getModel: function(t, e) {
          var r,
            o =
              null == t ? this.option : i(this.option, (t = this.parsePath(t)));
          return (
            (e = e || ((r = a(this, t)) && r.getModel(t))),
    ...
    function(t, e, r) {
      ...
      function o(t) {
        var e = { main: "", sub: "" };
        return (
          t && ((t = t.split(g)), (e.main = t[0] || ""), (e.sub = t[1] || "")),
          e
        );
      }
      function s(t) {
    ...
    function(t, e, r) {
      ...
      function h(t) {
        var e = t.shape,
          r = t.style.lineWidth;
        return (
          vt(2 * e.x1) === vt(2 * e.x2) && (e.x1 = e.x2 = c(e.x1, r, !0)),
          vt(2 * e.y1) === vt(2 * e.y2) && (e.y1 = e.y2 = c(e.y1, r, !0)),
          t
        );
      }
      function u(t) {
        ...
        return (
          (e.x = c(e.x, r, !0)),
          (e.y = c(e.y, r, !0)),
          (e.width = Math.max(c(n + a, r, !1) - e.x, 0 === a ? 0 : 1)),
          (e.height = Math.max(c(i + o, r, !1) - e.y, 0 === o ? 0 : 1)),
          t
        );
      }
      function c(t, e, r) {
      ...
      function d(t) {
        return "string" == typeof t ? G.lift(t, -0.1) : t;
      }
      function v(t) {
        if (t.__hoverStlDirty) {
          var e = t.style.stroke,
            r = t.style.fill,
            n = t.__hoverStl;
          (n.fill = n.fill || (f(r) ? d(r) : null)),
            (n.stroke = n.stroke || (f(e) ? d(e) : null));
          var i = {};
        ...
        if (!t.__isHover) {
          if ((v(t), t.useHoverLayer))
            ...
            r && L(e),
              ...
              r &&
                (D(e, e.insideOriginalTextPosition, r),
                null == e.textFill && (e.textFill = r.autoColor)),
              t.dirty(!1),
              (t.z2 += 1);
          }
          t.__isHover = !0;
      ...
      function w(t) {
        (this.__hoverSilentOnTouch && t.zrByTouch) ||
          (!this.__isEmphasis && m(this));
      }
      function _(t) {
        (this.__hoverSilentOnTouch && t.zrByTouch) ||
          (!this.__isEmphasis && x(this));
      }
      function b() {
      ...
      function M(t, e, r) {
        (t.__hoverSilentOnTouch = r && r.hoverSilentOnTouch),
          "group" === t.type
            ...
            : y(t, e),
          t.on("mouseover", w).on("mouseout", _),
          t.on("emphasis", b).on("normal", S);
      }
      function T(t, e, r, n, i, a, o) {
        ...
        var s = i.labelFetcher,
          ...
          v = c
            ? Y.retrieve2(
                s ? s.getFormattedLabel(l, "emphasis", null, h) : null,
                f
              )
            : null;
        (null == d && null == v) || (k(t, r, a, i), k(e, n, o, i, !0)),
          (t.text = d),
          (e.text = v);
      }
      ...
      function A(t, e, r, n, i, a) {
        if (
          ((r = (!i && r) || mt),
          (t.textFill = O(e.getShallow("color"), n) || r.color),
          (t.textStroke =
            O(e.getShallow("textBorderColor"), n) || r.textBorderColor),
          (t.textStrokeWidth = Y.retrieve2(
        ...
        (t.fontStyle = e.getShallow("fontStyle") || r.fontStyle),
          ...
          (a && n.disableBox) ||
            ((t.textBackgroundColor = O(e.getShallow("backgroundColor"), n)),
            (t.textPadding = e.getShallow("padding")),
            (t.textBorderColor = O(e.getShallow("borderColor"), n)),
          ...
          (t.textShadowOffsetX =
            e.getShallow("textShadowOffsetX") || r.textShadowOffsetX),
          (t.textShadowOffsetY =
            e.getShallow("textShadowOffsetY") || r.textShadowOffsetY);
      }
      function O(t, e) {
      ...
      function R(t, e, r, n, i, a) {
        if (
          ...
          "function" == typeof h &&
            (h = h(
              i,
              n.getAnimationDelayParams ? n.getAnimationDelayParams(e, i) : null
            )),
      ...
      function E(t, e, r) {
        return (
          e && !Y.isArrayLike(e) && (e = Q.getLocalTransform(e)),
          r && (e = U.invert([], e)),
          $.applyTransform([], t, e)
        );
      }
      ...
      function X(t, e, r) {
        ...
        if (((r = r || { x: -1, y: -1, width: 2, height: 2 }), t))
          return 0 === t.indexOf("image://")
            ? ((n.image = t.slice(8)), Y.defaults(n, r), new K(e))
            : a(t.replace("path://", ""), e, r, "center");
      }
      var Y = r(0),
        V = r(39),
        G = r(18),
      ...
      (e.extendShape = n),
        ...
        (e.mergePath = xt),
        (e.resizePath = l),
        (e.subPixelOptimizeLine = h),
        (e.subPixelOptimizeRect = u),
        (e.subPixelOptimize = c),
        (e.setHoverStyle = M),
        (e.setLabelStyle = T),
        (e.setTextStyle = k),
        (e.setText = C),
        ...
        (e.getTransform = N),
        (e.applyTransform = E),
        (e.transformDirection = W),
        (e.groupTransition = q),
        (e.clipPointsByRect = H),
        (e.clipRectByRect = j),
        (e.createIcon = X);
    },
    function(t, e, r) {
        ...
        for (e = 1; e < a.length; e++) {
          ...
          for (; g < p.length && !isNaN(p[g]) && !isNaN(p[0]); ) {
            ...
            switch (v) {
              ...
              case "C":
                (c = h.C),
                  l.addData(c, p[g++], p[g++], p[g++], p[g++], p[g++], p[g++]),
                  (o = p[g - 2]),
                  (s = p[g - 1]);
                break;
              case "c":
              ...
              case "S":
                ...
                var C = l.len(),
                  P = l.data;
                i === h.C && ((x += o - P[C - 4]), (y += s - P[C - 3])),
                  (c = h.C),
                  (T = p[g++]),
                  (k = p[g++]),
                  (o = p[g++]),
                  (s = p[g++]),
                  l.addData(c, x, y, T, k, o, s);
                break;
              case "s":
                (x = o), (y = s);
                var C = l.len(),
    ...
    function(t, e) {
      ...
      a.prototype = {
        ...
        bind: function(t, e, r) {
          for (
            var n = this, a = r && r.style, o = !a, s = 0;
            s < i.length;
            s++
          ) {
            var l = i[s],
          ...
          if (
            ((o || n.fill !== a.fill) && (t.fillStyle = n.fill),
            (o || n.stroke !== a.stroke) && (t.strokeStyle = n.stroke),
            (o || n.opacity !== a.opacity) &&
        ...
        extendFrom: function(t, e) {
          if (t)
            for (var r in t)
              !t.hasOwnProperty(r) ||
                (!0 !== e &&
                  (!1 === e ? this.hasOwnProperty(r) : null == t[r])) ||
                (this[r] = t[r]);
        },
        set: function(t, e) {
    ...
    function(t, e, r) {
      ...
      c.prototype = {
        ...
        animate: function(t, e) {
          ...
          if (!r)
            return void i(
              'Property "' + t + '" is not existed in element ' + o.id
            );
          var d = o.animators,
            v = new n(r, e);
          return (
        ...
        animateTo: function(t, e, r, n, i, a) {
          ...
          o(r)
            ...
            : e || (e = 500),
            this.stopAnimation(),
            this._animateToShallow("", this, t, e, r);
    ...
    function(t, e, r) {
      ...
      function l(t, e, r) {
        ...
        if (n !== i) {
          if (n > i) t.length = i;
            ...
            for (var a = n; a < i; a++) t.push(1 === r ? e[a] : w.call(e[a]));
        }
      ...
      function h(t, e, r) {
        ...
        if (1 === r) {
          ...
          for (var a = t[0].length, i = 0; i < n; i++)
            for (var o = 0; o < a; o++) if (t[i][o] !== e[i][o]) return !1;
        return !0;
      }
      ...
      function c(t, e, r, n, i, a, o) {
        var s = 0.5 * (r - t),
          l = 0.5 * (n - e);
        return (
          (2 * (e - r) + s + l) * o + (-3 * (e - r) - 2 * s - l) * a + s * i + e
        );
      }
      function f(t) {
        if (y(t)) {
          ...
          if (f || !O) {
            ...
            var Y = function(t, e) {
                ...
                if (0 !== n)
                  ...
                  else if (M) s(I[r], I[r + 1], z, g(t, i), C);
                  else {
                    var l;
                    if (T) s(I[r], I[r + 1], z, X, 1), (l = d(X));
                    else {
      ...
      o.prototype = {
        ...
        drawRectText: function(t, e) {
          ...
          if ((null != i && (i += ""), n.needDrawText(i, r))) {
            ...
            r.transformText
              ? this.setTransform(t)
              : o && (a.copy(e), a.applyTransform(o), (e = a)),
    ...
    function(t, e, r) {
      ...
      function a(t, e, r, n, i, a, o, s, l, f) {
        var d,
          ...
          p = v(t, r, i, o, x);
        for (
          l[0] = 1 / 0, l[1] = 1 / 0, f[0] = -1 / 0, f[1] = -1 / 0, d = 0;
          d < p;
          d++
        ) {
          var m = g(t, r, i, o, x[d]);
      ...
      function s(t, e, r, n, i, a, o, s, h) {
        ...
        if (x % v < 1e-4 && x > 1e-4)
          return (
            (s[0] = t - r), (s[1] = e - n), (h[0] = t + r), void (h[1] = e + n)
          );
        if (
          ((g[0] = d(i) * r + t),
          (g[1] = f(i) * n + e),
    ...
    function(t, e, r) {
      ...
      function a(t, e, r, n, a, o, s, l, h, u) {
        ...
        for (var f, d, v = 0, g = -1, p = 0; p < c; p++) {
          var m = S[p],
            y = 0 === m || 1 === m ? 0.5 : 1;
          x.cubicAt(t, r, a, s, m) < h ||
            (g < 0 &&
              ((g = x.cubicExtrema(e, n, o, l, M)),
              M[1] < M[0] && g > 1 && i(),
              (f = x.cubicAt(e, n, o, l, M[0])),
              g > 1 && (d = x.cubicAt(e, n, o, l, M[1]))),
            2 == g
              ? m < M[0]
                ? (v += f < e ? y : -y)
                : m < M[1]
      ...
      function s(t, e, r, n, i, a, o, s) {
        ...
        for (var c = 0, f = 0; f < 2; f++) {
          ...
          if (d + t > o) {
            ...
            v < 0 && (v = _ + v),
              ((v >= n && v <= i) || (v + _ >= n && v + _ <= i)) &&
                (v > Math.PI / 2 && v < 1.5 * Math.PI && (u = -u), (c += u));
          }
        }
        return c;
      }
      function l(t, e, r, i, l) {
        for (var h = 0, u = 0, c = 0, p = 0, m = 0, x = 0; x < t.length; ) {
          var _ = t[x++];
          switch (
            (_ === w.M && x > 1 && (r || (h += y(u, c, p, m, i, l))),
            1 == x && ((u = t[x]), (c = t[x + 1]), (p = u), (m = c)),
            _)
          ) {
            case w.M:
              (p = t[x++]), (m = t[x++]), (u = p), (c = m);
            ...
            case w.Q:
              if (r) {
                if (
                  v.containStroke(u, c, t[x++], t[x++], t[x], t[x + 1], e, i, l)
                )
                  return !0;
            ...
            case w.R:
              ...
              if (r) {
                if (
                  f.containStroke(p, m, I, m, e, i, l) ||
                  f.containStroke(I, m, I, A, e, i, l) ||
                  f.containStroke(I, A, p, A, e, i, l) ||
                  f.containStroke(p, A, p, m, e, i, l)
                )
                  return !0;
    ...
    function(t, e, r) {
      function n(t, e, r, n, a, o, s, l, h, u, c) {
        ...
        return (
          !(
            (c > e + f && c > n + f && c > o + f && c > l + f) ||
            (c < e - f && c < n - f && c < o - f && c < l - f) ||
            (u > t + f && u > r + f && u > a + f && u > s + f) ||
            (u < t - f && u < r - f && u < a - f && u < s - f)
          ) && i.cubicProjectPoint(t, e, r, n, a, o, s, l, u, c, null) <= f / 2
        );
      }
      var i = r(4);
      e.containStroke = n;
      ...
      (n.prototype = {
        ...
        brush: function(t, e) {
          var r = this.style,
            n = r.image;
          r.bind(t, this, e);
          var i = (this._image = s.createOrUpdateImage(
            n,
            this._image,
            this,
            this.onload
          ...
          if (i && s.isImageReady(i)) {
            ...
            if (
              (null == l && null != h
                ...
                : null == h && null != l
                ? (h = l / u)
                : null == l && null == h && ((l = i.width), (h = i.height)),
              this.setTransform(t),
              r.sWidth && r.sHeight)
            ) {
              var c = r.sx || 0,
        ...
        return i.browser.ie && i.browser.version >= 11
          ? function() {
              ...
              if ((t.apply(this, arguments), e))
                for (var h = 0; h < a.length; h++) n[a[h][0]] = a[h][2];
            }
          : t;
      }
      var i = r(15),
      ...
      function i(t, e) {
        ...
        for (var s = 0; s < l; s++) {
          ...
          var p = v * v,
            m = v * p;
          i.push([
            n(h[0], g[0], u[0], c[0], v, p, m),
            n(h[1], g[1], u[1], c[1], v, p, m)
          ]);
        }
        return i;
      }
    ...
    function(t, e, r) {
      function n(t, e, r, n) {
        ...
        for (var y = 0, w = t.length; y < w; y++) {
          ...
          var T = h([], _, m),
            k = h([], _, x);
          n && (o(T, T, d), a(T, T, v), o(k, k, d), a(k, k, v)),
            g.push(T),
            g.push(k);
        }
    ...
    function(t, e, r) {
      function n(t, e, r) {
        ...
        return null === n || null === i
          ? [
              (r ? f : u)(t.x1, t.cpx1, t.cpx2, t.x2, e),
              (r ? f : u)(t.y1, t.cpy1, t.cpy2, t.y2, e)
            ]
          : [
              (r ? c : h)(t.x1, t.cpx1, t.x2, e),
              (r ? c : h)(t.y1, t.cpy1, t.y2, e)
            ];
      }
      var i = r(1),
        a = r(2),
      ...
      var n = r(1),
        i = n.extend({
          ...
          _updatePathDirty: function() {
            for (
              var t = this.__dirtyPath, e = this.shape.paths, r = 0;
              r < e.length;
              r++
            )
              t = t || e[r].__dirtyPath;
          ...
          beforeBrush: function() {
            ...
            for (
              var t = this.shape.paths || [], e = this.getGlobalScale(), r = 0;
              r < t.length;
              r++
            )
          ...
          getBoundingRect: function() {
            return (
              this._updatePathDirty(), n.prototype.getBoundingRect.call(this)
            );
          }
        });
      t.exports = i;
            ...
            (function() {
              ...
              var t = [void 0],
                ...
                r = function(r) {
                  var n = t.length;
                  return (
                    t.push(r), window.postMessage(e + n.toString(36), "*"), n
                  );
                };
              return (
            ...
            o = (function() {
              if (a) {
                for (
                  ...
                  if (
                    ((r.font = n.toString(10) + "px sans-serif"),
                    r.measureText("Ｗ").width === t &&
                      r.measureText("m").width === e)
                  )
                    return n + 1;
              ...
              if (a) {
                ...
                var b,
                  ...
                  T = function(t) {
                    ...
                    t.touches
                      ? ((e = t.touches[0].clientX), (r = t.touches[0].clientY))
                  ...
                  I = function(t) {
                    ...
                    for (0 === t && i.push([f[0], f[1], 0]); r--; ) {
                      var a = 1;
                      "circle" !== n.shape &&
                        (a = n.shape((r / e) * 2 * Math.PI)),
                        i.push([
                          f[0] + t * a * Math.cos((-r / e) * 2 * Math.PI),
                          f[1] +
                            t *
                              a *
                              Math.sin((-r / e) * 2 * Math.PI) *
                              n.ellipticity,
                          (r / e) * 2 * Math.PI
                        ]);
                    }
                  ...
                  A = function() {
                    return (
                      n.abortThreshold > 0 &&
                      new Date().getTime() - v > n.abortThreshold
                    );
                  },
                  O = function() {
                    return 0 === n.rotateRatio
                      ...
                      : 0 === x
                      ? y
                      : y + Math.round((Math.random() * x) / w) * w;
                  },
                  D = function(t, e, r) {
                    ...
                    var g = -h / 2,
                      m = 0.4 * -u,
                      x = Math.ceil(
                        (c * Math.abs(Math.sin(r)) +
                          f * Math.abs(Math.cos(r))) /
                          p
                      ),
                      y = Math.ceil(
                        (c * Math.abs(Math.cos(r)) +
                          f * Math.abs(Math.sin(r))) /
                          p
                      ),
                      w = y * p,
                      _ = x * p;
                        ...
                        if (t.getContext) {
                          ...
                          o.save(),
                            ...
                            o.fillText(
                              a,
                              i.fillTextOffsetX * s,
                              (i.fillTextOffsetY + 0.5 * f) * s
                            ),
                            o.restore();
                        } else {
                          var l = document.createElement("span"),
                            v = "";
                          (v = "rotate(" + (-h / Math.PI) * 180 + "deg) "),
                            1 !== i.mu &&
                              (v +=
                                "translateX(-" +
                                i.fillTextWidth / 4 +
                  ...
                  z = function(t) {
                    ...
                    Array.isArray(t)
                      ? ((e = t[0]), (r = t[1]))
                      : ((e = t.word), (r = t.weight), (i = t.attributes));
                    var a = O(),
                      o = D(e, r, a);
                    if (!o) return !1;
                    if (A()) return !1;
                    ...
                    for (var h = d + 1; h--; ) {
                      ...
                      for (var v = 0; v < f.length; v++) {
                        var g = (function(n) {
                          ...
                          o.gw, o.gh;
                          return (
                            !!L(s, l, 0, 0, o.occupied) &&
                            (F(s, l, o, e, r, d - h, n[2], a, i),
                            B(s, l, 0, 0, o, t),
                            { gx: s, gy: l, rot: a, info: o })
                          );
                        })(f[v]);
                        if (g) return g;
                      }
                ...
                !(function() {
                  var e = t[0];
                  if (e.getContext)
                    (u = Math.ceil(e.width / p)), (c = Math.ceil(e.height / p));
                  else {
                  ...
                  if (N("wordcloudstart", !0)) {
                    ...
                    if (!e.getContext || n.clearCanvas)
                        ...
                        t.forEach(function(t) {
                          if (t.getContext) {
                            ...
                            (e.fillStyle = n.backgroundColor),
                              e.clearRect(0, 0, u * (p + 1), c * (p + 1)),
                              e.fillRect(0, 0, u * (p + 1), c * (p + 1));
                      ...
                      var l = s.getImageData(0, 0, 1, 1).data,
                        g = e.getContext("2d").getImageData(0, 0, u * p, c * p)
                          .data;
                      i = u;
                      for (var m, x; i--; )
                        for (h[i] = [], a = c; a--; ) {
                    ...
                    var y, w;
                    0 !== n.wait
                      ? ((y = window.setTimeout), (w = window.clearTimeout))
                      : ((y = window.setImmediate),
                        (w = window.clearImmediate));
                    var _ = function(e, r) {
                        t.forEach(function(t) {
