(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else root["echarts-wordcloud"] = factory(root["echarts"]);
  ...
  return /******/ (function(modules) {
    ...
    /******/ [
      ...
      /***/ function(module, exports) {
        ...
        function bind(func, context) {
          ...
          return function() {
            return func.apply(
              context,
              args.concat(nativeSlice.call(arguments))
            );
          };
        }
        /**
          ...
          each: function(cb, context) {
            ...
            for (var prefixedKey in this) {
              this.hasOwnProperty(prefixedKey) &&
                cb(
                  this[prefixedKey],
                  prefixedKey.slice(HASH_MAP_PREFIX_LENGTH)
                );
            }
          },
      ...
      /***/ function(module, exports) {
        var ArrayCtor =
          typeof Float32Array === "undefined" ? Array : Float32Array;
        /**
         * 创建一个向量
         * @param {number} [x=0]
         * @param {number} [y=0]
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        BoundingRect.prototype = {
          ...
          union: function(other) {
            ...
            this.width =
              mathMax(other.x + other.width, this.x + this.width) - x;
            this.height =
              mathMax(other.y + other.height, this.y + this.height) - y;
            this.x = x;
            this.y = y;
          },
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function truncateText(text, containerWidth, font, ellipsis, options) {
          ...
          var textLines = (text + "").split("\n");
          options = prepareTruncateOptions(
            containerWidth,
            font,
            ellipsis,
            options
        ...
        function parseRichText(text, style) {
          ...
          if (stlPadding) {
            truncateWidth != null &&
              (truncateWidth -= stlPadding[1] + stlPadding[3]);
            truncateHeight != null &&
              (truncateHeight -= stlPadding[0] + stlPadding[2]);
          ...
          for (var i = 0; i < lines.length; i++) {
            ...
            for (var j = 0; j < line.tokens.length; j++) {
              ...
              var tokenStyle =
                (token.styleName && style.rich[token.styleName]) || {}; // textPadding should not inherit from style.
              ...
              token.lineHeight = retrieve3(
                tokenStyle.textLineHeight,
                style.textLineHeight,
                tokenHeight
              );
              token.textAlign =
                (tokenStyle && tokenStyle.textAlign) || style.textAlign;
              token.textVerticalAlign =
                (tokenStyle && tokenStyle.textVerticalAlign) || "middle";

              if (
                truncateHeight != null &&
                contentHeight + token.lineHeight > truncateHeight
              ) {
                return {
                  lines: [],
                  width: 0,
              ...
              var tokenWidthNotSpecified =
                tokenWidth == null || tokenWidth === "auto"; // Percent width, can be `100%`, can be used in drawing separate
              // line when box width is needed to be auto.

              if (
                typeof tokenWidth === "string" &&
                tokenWidth.charAt(tokenWidth.length - 1) === "%"
              ) {
                ...
                var paddingW = textPadding
                  ? textPadding[1] + textPadding[3]
                  : 0;
                tokenWidth += paddingW;
                var remianTruncWidth =
                  truncateWidth != null ? truncateWidth - lineWidth : null;
          ...
          for (var i = 0; i < strs.length; i++) {
            ...
            if (!i) {
              ...
              tokensLen === 1 && tokens[0].isLineHolder
                ? (tokens[0] = token) // Consider text is '', only insert when it is the "lineHolder" or
          ...
          return (
            ((style.fontSize || style.fontFamily) &&
              [
                style.fontStyle,
                style.fontWeight,
                (style.fontSize || 12) + "px", // If font properties are defined, `fontFamily` should not be ignored.
        ...
        PathProxy.prototype = {
          ...
          lineTo: function(x, y) {
            var exceedUnit =
              ...
              mathAbs(y - this._yi) > this._uy || // Force draw the first segment
              this._len < 5;
            this.addData(CMD.L, x, y);

            if (this._ctx && exceedUnit) {
              this._needsDash()
                ? this._dashedLineTo(x, y)
          ...
          _dashedBezierTo: function(x1, y1, x2, y2, x3, y3) {
            ...
            for (t = 0; t < 1; t += 0.1) {
              dx =
                cubicAt(x0, x1, x2, x3, t + 0.1) - cubicAt(x0, x1, x2, x3, t);
              dy =
                cubicAt(y0, y1, y2, y3, t + 0.1) - cubicAt(y0, y1, y2, y3, t);
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function getPixelPrecision(dataExtent, pixelExtent) {
          var log = Math.log;
          var LN10 = Math.LN10;
          var dataQuantity = Math.floor(
            log(dataExtent[1] - dataExtent[0]) / LN10
          );
        ...
        function _default(properties) {
          ...
          return function(model, excludes, includes) {
            ...
            for (var i = 0; i < properties.length; i++) {
              ...
              if (
                (excludes && zrUtil.indexOf(excludes, propName) >= 0) ||
      ...
      /***/ function(module, exports) {
        ...
        function detect(ua) {
          ...
          var ie =
            ua.match(/MSIE\s([\d.]+)/) || ua.match(/Trident\/.+?rv:(([\d.]+))/); // IE 11 Trident/7.0; rv:11.0
          ...
          return {
            ...
            pointerEventsSupported:
              "onpointerdown" in window && // Firefox supports pointer but not by default, only MS browsers are reliable on pointer
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function putToCache(colorStr, rgbaArr) {
          ...
          lastRemovedArr = colorCache.put(
            colorStr,
            lastRemovedArr || rgbaArr.slice()
          );
        }
        /**
      ...
      /***/ function(module, exports, __webpack_require__) {
          ...
          if (style) {
            ...
            style.textAlign =
              textAlign == null || VALID_TEXT_ALIGN[textAlign]
                ? textAlign
                : "left"; // Compatible with textBaseline.
            ...
            style.textVerticalAlign =
              ...
              VALID_TEXT_VERTICAL_ALIGN[textVerticalAlign]
                ? textVerticalAlign
                : "top";
        ...
        function renderPlainText(hostEl, ctx, text, style, rect) {
          var font = setCtx(
            ctx,
            "font",
            style.font || textContain.DEFAULT_FONT
          );
          var textPadding = style.textPadding;
          ...
          var boxY = textContain.adjustTextY(
            baseY,
            outerHeight,
            textVerticalAlign
          );
        ...
        function drawRichText(hostEl, ctx, contentBlock, style, rect) {
          ...
          for (var i = 0; i < contentBlock.lines.length; i++) {
            ...
            while (
              ...
              !token.textAlign || token.textAlign === "left")
            ) {
              placeToken(
                hostEl,
                ctx,
        ...
        function placeToken(
          ...
          setCtx(
            ctx,
            "shadowBlur",
            retrieve3(tokenStyle.textShadowBlur, style.textShadowBlur, 0)
          );
          setCtx(
            ctx,
            "shadowColor",
            tokenStyle.textShadowColor || style.textShadowColor || "transparent"
          );
          setCtx(
            ctx,
            "shadowOffsetX",
            retrieve3(tokenStyle.textShadowOffsetX, style.textShadowOffsetX, 0)
          );
          setCtx(
            ctx,
            "shadowOffsetY",
            retrieve3(tokenStyle.textShadowOffsetY, style.textShadowOffsetY, 0)
          );
          ...
          var textStroke = getStroke(
            tokenStyle.textStroke || style.textStroke,
            textStrokeWidth
          );
          var textFill = getFill(tokenStyle.textFill || style.textFill);
          var textStrokeWidth = retrieve2(
            tokenStyle.textStrokeWidth,
        ...
        function getStroke(stroke, lineWidth) {
          return stroke == null ||
            ...
            stroke === "transparent" ||
            stroke === "none"
            ? null // TODO pattern and gradient?
            ...
            textStyle &&
              echarts.util.each(compats, function(key) {
                if (textStyle.hasOwnProperty(key)) {
                  textStyle["text" + echarts.format.capitalFirst(key)] =
                    textStyle[key];
                }
              });
          }
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function boxLayout(orient, group, gap, maxWidth, maxHeight) {
          ...
          group.eachChild(function(child, idx) {
            ...
            if (orient === "horizontal") {
              var moveX =
                rect.width + (nextChildRect ? -nextChildRect.x + rect.x : 0);
              ...
              var moveY =
                rect.height + (nextChildRect ? -nextChildRect.y + rect.y : 0);
        ...
        function getAvailableSize(positionInfo, containerRect, margin) {
          ...
          (isNaN(x2) || isNaN(parseFloat(positionInfo.x2))) &&
            (x2 = containerWidth);
          (isNaN(y) || isNaN(parseFloat(positionInfo.y))) && (y = 0);
          (isNaN(y2) || isNaN(parseFloat(positionInfo.y2))) &&
            (y2 = containerHeight);
        ...
        function positionElement(el, positionInfo, containerRect, margin, opt) {
          ...
          el.attr(
            "position",
            boundingMode === "raw" ? [dx, dy] : [elPos[0] + dx, elPos[1] + dy]
          );
        }
        /**
        ...
        function sizeCalculable(option, hvIdx) {
          return (
            option[HV_NAMES[hvIdx][0]] != null ||
            (option[HV_NAMES[hvIdx][1]] != null &&
              option[HV_NAMES[hvIdx][2]] != null)
          );
        }
        /**
         * Consider Case:
        ...
        function mergeLayoutParam(targetOption, newOption, opt) {
          ...
          !zrUtil.isArray(ignoreSize) &&
            (ignoreSize = [ignoreSize, ignoreSize]);
        ...
        function copyLayoutParams(target, source) {
          source &&
            target &&
            each(LOCATION_PARAMS, function(name) {
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function completeDimensions(sysDims, data, opt) {
          ...
          encodeDef.each(function(dataDims, coordDim) {
            dataDims = encodeDef.set(
              coordDim,
              normalizeToArray(dataDims).slice()
            );
            each(dataDims, function(resultDimIdx, coordDimIndex) {
              // The input resultDimIdx can be dim name or index.
              isString(resultDimIdx) &&
                (resultDimIdx = dataDimNameMap.get(resultDimIdx));
          ...
          each(sysDims, function(sysDimItem, sysDimIndex) {
            ...
            if (!dataDims.length) {
              for (
                ...
                while (
                  availDimIdx < result.length &&
                  result[availDimIdx].coordDim != null
                ) {
                  availDimIdx++;
                }
            ...
            each(dataDims, function(resultDimIdx, coordDimIndex) {
              ...
              if (resultItem.name == null && sysDimItemDimsDef) {
                resultItem.name = resultItem.tooltipName =
          ...
          for (var resultDimIdx = 0; resultDimIdx < dimCount; resultDimIdx++) {
            ...
            resultItem.name == null &&
              (resultItem.name = genName(resultItem.coordDim, dataDimNameMap));
        ...
        var guessOrdinal = (completeDimensions.guessOrdinal = function(
          data,
          dimIndex
        ) {
        ...
        function defaultEmphasis(opt, subOpts) {
          if (opt) {
            ...
            for (var i = 0, len = subOpts.length; i < len; i++) {
              ...
              if (
                !emphasisOpt.hasOwnProperty(subOptName) &&
        ...
        function mappingToExists(exists, newCptOptions) {
          ...
          each(newCptOptions, function(cptOption, index) {
            ...
            for (var i = 0; i < result.length; i++) {
              if (
                !result[i].option && // Consider name: two map to one.
                cptOption.id != null &&
          ...
          each(newCptOptions, function(cptOption, index) {
            ...
            for (; i < result.length; i++) {
              ...
              if (
                !result[i].option && // Existing model that already has id should be able to
          ...
          each(finder, function(value, key) {
            ...
            if (
              ...
              (opt &&
                ...
                zrUtil.indexOf(opt.includeMainTypes, mainType) < 0)
            ) {
              return;
            }
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function getParent(model, path) {
          ...
          return getParentMethod
            ? getParentMethod.call(model, path)
            : model.parentModel;
        } // Enable Model.extend.
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function subPixelOptimizeRect(param) {
          ...
          shape.height = Math.max(
            subPixelOptimize(originY + originHeight, lineWidth, false) -
              shape.y,
            originHeight === 0 ? 0 : 1
          );
          return param;
        ...
        function doSingleEnterHover(el) {
          ...
          if (el.useHoverLayer) {
            ...
            if (insideRollbackOpt) {
              applyInsideStyle(
                style,
                style.insideOriginalTextPosition,
                insideRollbackOpt
        ...
        function setHoverStyle(el, hoverStyle, opt) {
          ...
          el.on("mouseover", onElementMouseOver).on(
            "mouseout",
            onElementMouseOut
        ...
        function setTokenTextStyle(
          ...
          if (!isEmphasis) {
            if (isBlock) {
              ...
              textStyle.insideRollback = applyInsideStyle(
                textStyle,
          ...
          if (!isBlock || !opt.disableBox) {
            ...
            textStyle.textBorderWidth = textStyleModel.getShallow(
              "borderWidth"
            );
            textStyle.textBorderRadius = textStyleModel.getShallow(
              "borderRadius"
            );
            textStyle.textBoxShadowColor = textStyleModel.getShallow(
              "shadowColor"
            );
            textStyle.textBoxShadowBlur = textStyleModel.getShallow(
              "shadowBlur"
            );
            textStyle.textBoxShadowOffsetX = textStyleModel.getShallow(
              "shadowOffsetX"
            );
            textStyle.textBoxShadowOffsetY = textStyleModel.getShallow(
              "shadowOffsetY"
            );
          }
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function processArc(x1, y1, x2, y2, fa, fs, rx, ry, psiDeg, cmd, path) {
          ...
          var xp =
            (mathCos(psi) * (x1 - x2)) / 2.0 + (mathSin(psi) * (y1 - y2)) / 2.0;
          var yp =
            (-1 * mathSin(psi) * (x1 - x2)) / 2.0 +
        ...
        Style.prototype = {
          ...
          bind: function(ctx, el, prevEl) {
            ...
            if (this.hasStroke()) {
              ...
              ctx.lineWidth =
                lineWidth /
                (this.strokeNoScale && el && el.getLineScale
                  ? el.getLineScale()
                  : 1);
            }
          },
          ...
          extendFrom: function(otherStyle, overwrite) {
            if (otherStyle) {
              for (var name in otherStyle) {
                if (
                  otherStyle.hasOwnProperty(name) &&
                  (overwrite === true ||
                    (overwrite === false
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function createTrackClip(
          ...
          for (var i = 0; i < trackLen; i++) {
            ...
            if (
              !(
                (isValueArray && isArraySame(value, prevValue, arrDim)) ||
          ...
          isValueArray &&
            fillArr(getter(animator._target, propName), lastValue, arrDim); // Cache the key of last frame to speed up when
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        Clip.prototype = {
          ...
          step: function(globalTime, deltaTime) {
            ...
            var percent =
              (globalTime - this._startTime - this._pausedTime) / this._life; // 还没开始
            ...
            var easingFunc =
              typeof easing == "string" ? easingFuncs[easing] : easing;
            var schedule =
              typeof easingFunc === "function" ? easingFunc(percent) : percent;
          ...
          restart: function(globalTime) {
            var remainder =
              (globalTime - this._startTime - this._pausedTime) % this._life;
          ...
          for (var i = 0; i < data.length; ) {
            ...
            switch (cmd) {
              ...
              case CMD.R:
                ...
                if (isStroke) {
                  if (
                    line.containStroke(x0, y0, x1, y0, lineWidth, x, y) ||
        ...
        Text.prototype = {
          ...
          getBoundingRect: function() {
            ...
            if (!this._rect) {
              ...
              if (
                textHelper.getStroke(style.textStroke, style.textStrokeWidth)
              ) {
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function someVectorAt(shape, t, isTangent) {
          ...
          if (cpx2 === null || cpy2 === null) {
            ...
            return [
              (isTangent ? quadraticDerivativeAt : quadraticAt)(
                shape.x1,
                shape.cpx1,
                shape.x2,
                t
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        echarts.extendChartView({
          ...
          render: function(seriesModel, ecModel, api) {
            ...
            seriesModel.layoutInstance.ondraw = function(
              text,
              size,
              dataIdx,
              drawn
              ...
              var emphasisTextStyleModel = itemModel.getModel(
                "textStyle.emphasis"
              );
        ...
        */
                ...
                case "pentagon":
                  settings.shape = function shapePentagon(theta) {
                    ...
                    return (
                      1 /
                      (Math.cos(thetaPrime) + 0.726543 * Math.sin(thetaPrime))
                    );
                  };
                  break;
