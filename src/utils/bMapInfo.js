     ...
     baidu.object.extend(InfoBox.prototype,{
         ...
         _adjustPosition: function(poi){
             ...
             switch(this._opts.align){
                 case INFOBOX_AT_TOP:
                     if(this._marker){
                         this._div.style.bottom = -(pixel.y - this._opts.offset.height - icon.anchor.height + icon.infoWindowAnchor.height) - this._marker.getOffset().height + 20 + "px";
                     }else{
                         this._div.style.bottom = -(pixel.y - this._opts.offset.height+20) + "px";
                     }
                     break;
